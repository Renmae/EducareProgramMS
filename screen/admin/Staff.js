  ...
  return (
    <ScreenWrapper>
      <View style={styles.container}>
        <Text style={styles.title}>Staff Masterlist</Text>
        ...
        <View style={[styles.tableRow, styles.tableHeader]}>
          ...
          <Text style={styles.cellHeader}>Center</Text>
          <Text style={styles.cellHeader}>Barangay</Text>
        ...
        <FlatList
          ...
          renderItem={({ item, index }) => (
            <View style={styles.tableRow}>
              ...
              <Text style={styles.cell}>{item.center}</Text>
